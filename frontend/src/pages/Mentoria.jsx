        ...
        >
          ...
          <div className="relative card-premium overflow-hidden min-h-[750px] border border-gold/20 shadow-2xl">
            ...
            <div className="bg-white"> {/* Hard white bed to match Google Calendar native appearance */}
              <iframe
                src="https://calendar.google.com/calendar/appointments/schedules/AcZssZ2PFBenM3-k489mFpnu2V8rR8hcIK6glAaZmwjY24LA29NzI0sq0hGrSy2L7klFVPrqvUabg6Lo?gv=true"
                style={{ border: 0 }}
                width="100%"
                height="700"
                frameBorder="0"
